...
const LoginPage = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      {/* left  */}
      <img src={assets.logo_big} alt="" className='w-[min(30vw,250px)] relative z-10'/>
      {/* right  */}

      <form onSubmit={onSubmitHandler} className='relative z-20 border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
